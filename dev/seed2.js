...
async function seed() {
    ...
    for (let i = 1; i<=10; i++){
        ...
        let email = ['email1@gmail.com','email2@gmail.com','email3@gmail.com','email4@gmail.com','email4@gmail.com','email5@gmail.com',
                    'email6@gmail.com','email7@gmail.com','email8@gmail.com','email9@gmail.com','email10@gmail.com','email1@gmail.com']
        // console.log(data)
    ...
    for (let i =1; i<=10; i++){
        for(let a= 1; a<=5; a++){
            ...
            const messages=['success login', 'complete your payment course', 'lets get start your course', 'payment complete', 'ayam bakar segera sampai', 'driver lagi kena macet']
